...
public class SeleniumTestsuiteBuilder {
	...
	public void write(File dir) {
		...
		File file = new File(dir.getPath() + "/" + name + "TestSuite");
	...
	public SeleniumTestsuiteBuilder setBaseUrl(String url) {
		for (SeleniumTestcaseBuilder testcase : getTestcases()) {
			testcase.setBaseUrl(url);
		}
		return this;
	}
