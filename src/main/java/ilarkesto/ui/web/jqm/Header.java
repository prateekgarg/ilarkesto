...
public class Header extends AHtmlContainerElement {
	...
	public Header setDataThemeToA() {
		return setDataTheme("a");
	}

	public Header setDataThemeToB() {
		return setDataTheme("b");
	}

	public Header setDataThemeToC() {
		return setDataTheme("c");
	}

	public Header setDataThemeToD() {
		return setDataTheme("D");
	}

	public Header setDataTheme(String dataTheme) {
	...
	protected void renderHeader(HtmlRenderer html) {
		...
		if (dataTheme != null) div.set("data-theme", dataTheme);
	}
