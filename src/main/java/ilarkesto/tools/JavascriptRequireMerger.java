...
public class JavascriptRequireMerger {
	...
	public void processFile(PrintWriter out, File file) {
		if (file.isDirectory()) throw new RuntimeException("Not implemented yet.");
		String content = IO.readFile(file);
		beforeFile(out, file.getName());
		out.println(content);
		afterFile(out);
	}
	...
	private void beforeFiles(PrintWriter out) {
		out.print("// generated by browsermodules.js\n");
