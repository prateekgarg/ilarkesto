...
public class AgplTemplate implements CopyrightTemplate {
	...
	public String getText(String years, String... owners) {
		...
		sb.append("\n");
		sb.append(" * \n");
		sb.append(" * Foobar is free software: you can redistribute it and/or modify it under the terms of the GNU Affero General Public\n");
		...
		sb.append(" * \n");
		sb.append(" * Foobar is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the\n");
