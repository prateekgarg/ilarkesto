 ...
 */
/*
 * net.sf.jazzlib.ZipOutputStream Copyright (C) 2001 Free Software Foundation, Inc. This file is part of GNU
 * Classpath. GNU Classpath is free software; you can redistribute it and/or modify it under the terms of the
 * GNU General Public License as published by the Free Software Foundation; either version 2, or (at your
 * option) any later version. GNU Classpath is distributed in the hope that it will be useful, but WITHOUT ANY
 ...
 * License along with GNU Classpath; see the file COPYING. If not, write to the Free Software Foundation,
 * Inc., 59 Temple Place, Suite 330, Boston, MA 02111-1307 USA. Linking this library statically or dynamically
 * with other modules is making a combined work based on this library. Thus, the terms and conditions of the
 * GNU General Public License cover the whole combination. As a special exception, the copyright holders of
 * this library give you permission to link this library with independent modules to produce an executable,
 * regardless of the license terms of these independent modules, and to copy and distribute the resulting
 * executable under terms of your choice, provided that you also meet, for each linked independent module, the
 * terms and conditions of the license of that module. An independent module is a module which is not derived
 * from or based on this library. If you modify this library, you may extend this exception to your version of
...
/**
 * This is a FilterOutputStream that writes the files into a zip archive one after another. It has a special
 * method to start a new zip entry. The zip entries contains information about the file name size, compressed
 * size, CRC, etc. It includes support for STORED and DEFLATED entries. This class is not thread safe.
 * 
...
public class ZipOutputStream extends DeflaterOutputStream implements ZipConstants {
	...
	/**
	 * Starts a new Zip entry. It automatically closes the previous entry if present. If the compression
	 * method is stored, the entry must have a valid size and crc, otherwise all elements (except name) are
	...
	public void finish() throws IOException {
		...
		Enumeration enume = entries.elements();
