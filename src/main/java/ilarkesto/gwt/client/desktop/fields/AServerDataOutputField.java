...
public abstract class AServerDataOutputField extends OutputField implements DataForClientLoader {
	...
	protected abstract IsWidget createDisplayWidgetAfterLoaded(ADataTransferObject result);

	public AServerDataOutputField(String label) {
		super(label, "...");
	}
	...
	public IsWidget createDisplayWidget() {
		...
		return createDisplayWidgetAfterLoaded(dto);
	}
